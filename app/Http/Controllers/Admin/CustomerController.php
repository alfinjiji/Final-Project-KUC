...
class CustomerController extends Controller
{
    function customer()
    {
        ...
        return view('admin.customer',['cust'=>$customer]);
    ...
    {  
       ...
       $address=customerAddress::where('customer_id','=',$id)->get();
        return view('admin.customer_address',['address'=>$address]);
    }
    ...
    {  
        ...
        return view('admin.customer_order',['order'=>$order,'product'=>$product]);
    }
}
